...
#define DEFINE_CCW_UBUNTU_MACHINE_IMPL(latest, prefix, machinename, ...)      \
    ...
    static void MACHINE_VER_SYM(instance_init, prefix, __VA_ARGS__)(Object *obj) \
    {                                                                         \
        MachineState *machine = MACHINE(obj);                                 \
        current_mc = S390_CCW_MACHINE_CLASS(MACHINE_GET_CLASS(machine));      \
        MACHINE_VER_SYM(instance_options, ccw, __VA_ARGS__)(machine);         \
    ...
    {                                                                         \
        ...
        .instance_init = MACHINE_VER_SYM(instance_init, prefix, __VA_ARGS__),    \
    };                                                                        \
...
DEFINE_CCW_UBUNTU_MACHINE(xenial, 2, 5);
DEFINE_CCW_UBUNTU_MACHINE(yakkety, 2, 6);
DEFINE_CCW_UBUNTU_MACHINE(zesty, 2, 8);
DEFINE_CCW_UBUNTU_MACHINE(artful, 2, 10);
DEFINE_CCW_UBUNTU_MACHINE(bionic, 2, 11);
DEFINE_CCW_UBUNTU_MACHINE(cosmic, 2, 12);
DEFINE_CCW_UBUNTU_MACHINE(disco, 3, 1);
DEFINE_CCW_UBUNTU_MACHINE(eoan, 3, 1);
DEFINE_CCW_UBUNTU_MACHINE(focal, 4, 2);
...
DEFINE_CCW_UBUNTU_MACHINE_AS_LATEST(plucky, 9, 2);
